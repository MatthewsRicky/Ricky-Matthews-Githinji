...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        Hi, I&apos;m{" "}
        <span className="text-sky-700 dark:text-[gold]">Ricky</span>, a
        self-taught{" "}
      ...
      >
        <Link
          href="#contact"
          className="group bg-slate-900 flex text-white px-7 items-center py-3 gap-3 rounded-full focus:scale-110 outline-none hover:scale-110 hover:bg-slate-950 active:scale-105 mr-4 transition"
          onClick={() => {
